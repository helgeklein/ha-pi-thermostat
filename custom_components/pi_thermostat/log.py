...
Usage:
    ...
    # Output: [custom_components.pi_thermostat] Starting setup
    ...
    # Output: [custom_components.pi_thermostat.67890] Cover moved
...
# __package__ is "custom_components.pi_thermostat" when imported as a package.
