...
numeric settings of the PI Thermostat integration.
"""
...
class IntegrationNumber(IntegrationEntity, NumberEntity):  # pyright: ignore[reportIncompatibleVariableOverride]
    """Base number entity for PI Thermostat integration.
    ...
    def __init__(
        ...
        # This will result in entity_id: number.pi_thermostat_{translation_key}
