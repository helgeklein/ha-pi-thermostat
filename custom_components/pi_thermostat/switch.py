...
PI Thermostat integration. The switches allow users to control
the automation behavior through the Home Assistant interface.

The switches that appear in Home Assistant are:
- Entity: switch.pi_thermostat_enabled - Master automation enable/disable
- Entity: switch.pi_thermostat_simulation_mode - Simulation mode control
"""
...
class IntegrationSwitch(IntegrationEntity, SwitchEntity):  # pyright: ignore[reportIncompatibleVariableOverride]
    """Base switch entity for PI Thermostat integration.
    ...
    def __init__(
        ...
        # This will result in entity_id: switch.pi_thermostat_{translation_key}
...
class VerboseLoggingSwitch(IntegrationSwitch):
    ...
    def is_on(self) -> bool:  # pyright: ignore
        ...
        logger = logging.getLogger("custom_components.pi_thermostat")
